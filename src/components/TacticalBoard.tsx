...
const FORMATIONS: Record<number, Formation[]> = {
  ...
  6: [
    { id: '2-2-1', name: 'Equilibrada (2-2-1)', pos: [{role: 'GK', x: 8, y: 50}, {role: 'LCB', x: 22, y: 30}, {role: 'RCB', x: 22, y: 70}, {role: 'LM', x: 35, y: 30}, {role: 'RM', x: 35, y: 70}, {role: 'ST', x: 45, y: 50}], links: [['GK', 'LCB'], ['GK', 'RCB'], ['LCB', 'RCB'], ['LCB', 'LM'], ['RCB', 'RM'], ['LM', 'ST'], ['RM', 'ST'], ['LM', 'RM']] },
    { id: '3-1-1', name: 'Defensiva (3-1-1)', pos: [{role: 'GK', x: 8, y: 50}, {role: 'LB', x: 20, y: 20}, {role: 'CB', x: 18, y: 50}, {role: 'RB', x: 20, y: 80}, {role: 'CM', x: 32, y: 50}, {role: 'ST', x: 45, y: 50}], links: [['GK', 'LB'], ['GK', 'CB'], ['GK', 'RB'], ['LB', 'CB'], ['CB', 'RB'], ['LB', 'CM'], ['CB', 'CM'], ['RB', 'CM'], ['CM', 'ST']] },
    { id: '1-3-1', name: 'Ofensiva (1-3-1)', pos: [{role: 'GK', x: 8, y: 50}, {role: 'CB', x: 20, y: 50}, {role: 'LM', x: 32, y: 20}, {role: 'CM', x: 30, y: 50}, {role: 'RM', x: 32, y: 80}, {role: 'ST', x: 45, y: 50}], links: [['GK', 'CB'], ['CB', 'LM'], ['CB', 'CM'], ['CB', 'RM'], ['LM', 'CM'], ['CM', 'RM'], ['LM', 'ST'], ['CM', 'ST'], ['RM', 'ST']] }
  ],
  7: [
  ...
  8: [
    { id: '3-3-1', name: 'Equilibrada (3-3-1)', pos: [{role: 'GK', x: 4, y: 50}, {role: 'LB', x: 15, y: 20}, {role: 'CB', x: 12, y: 50}, {role: 'RB', x: 15, y: 80}, {role: 'LM', x: 28, y: 20}, {role: 'CM', x: 26, y: 50}, {role: 'RM', x: 28, y: 80}, {role: 'ST', x: 42, y: 50}], links: [['GK', 'LB'], ['GK', 'CB'], ['GK', 'RB'], ['LB', 'CB'], ['CB', 'RB'], ['LB', 'LM'], ['CB', 'CM'], ['RB', 'RM'], ['LM', 'CM'], ['CM', 'RM'], ['LM', 'ST'], ['CM', 'ST'], ['RM', 'ST']] },
    { id: '2-4-1', name: 'Control (2-4-1)', pos: [{role: 'GK', x: 4, y: 50}, {role: 'LCB', x: 15, y: 30}, {role: 'RCB', x: 15, y: 70}, {role: 'LM', x: 28, y: 15}, {role: 'LCM', x: 26, y: 35}, {role: 'RCM', x: 26, y: 65}, {role: 'RM', x: 28, y: 85}, {role: 'ST', x: 42, y: 50}], links: [['GK', 'LCB'], ['GK', 'RCB'], ['LCB', 'RCB'], ['LCB', 'LM'], ['LCB', 'LCM'], ['RCB', 'RCM'], ['RCB', 'RM'], ['LM', 'LCM'], ['LCM', 'RCM'], ['RCM', 'RM'], ['LCM', 'ST'], ['RCM', 'ST']] },
    { id: '3-2-2', name: 'Ofensiva (3-2-2)', pos: [{role: 'GK', x: 4, y: 50}, {role: 'LB', x: 15, y: 20}, {role: 'CB', x: 12, y: 50}, {role: 'RB', x: 15, y: 80}, {role: 'LCM', x: 28, y: 35}, {role: 'RCM', x: 28, y: 65}, {role: 'LST', x: 42, y: 35}, {role: 'RST', x: 42, y: 65}], links: [['GK', 'LB'], ['GK', 'CB'], ['GK', 'RB'], ['LB', 'CB'], ['CB', 'RB'], ['LB', 'LCM'], ['CB', 'LCM'], ['CB', 'RCM'], ['RB', 'RCM'], ['LCM', 'RCM'], ['LCM', 'LST'], ['RCM', 'RST'], ['LCM', 'RST'], ['RCM', 'LST'], ['LST', 'RST']] }
  ],
  9: [
    { id: '3-3-2', name: 'Equilibrada (3-3-2)', pos: [{role: 'GK', x: 4, y: 50}, {role: 'LB', x: 15, y: 20}, {role: 'CB', x: 12, y: 50}, {role: 'RB', x: 15, y: 80}, {role: 'LM', x: 28, y: 25}, {role: 'CM', x: 26, y: 50}, {role: 'RM', x: 28, y: 75}, {role: 'LST', x: 42, y: 35}, {role: 'RST', x: 42, y: 65}], links: [['GK', 'LB'], ['GK', 'CB'], ['GK', 'RB'], ['LB', 'CB'], ['CB', 'RB'], ['LB', 'LM'], ['CB', 'CM'], ['RB', 'RM'], ['LM', 'CM'], ['CM', 'RM'], ['LM', 'LST'], ['CM', 'LST'], ['CM', 'RST'], ['RM', 'RST'], ['LST', 'RST']] },
    { id: '4-3-1', name: 'Defensiva (4-3-1)', pos: [{role: 'GK', x: 4, y: 50}, {role: 'LB', x: 15, y: 15}, {role: 'LCB', x: 12, y: 35}, {role: 'RCB', x: 12, y: 65}, {role: 'RB', x: 15, y: 85}, {role: 'LCM', x: 26, y: 30}, {role: 'CM', x: 24, y: 50}, {role: 'RCM', x: 26, y: 70}, {role: 'ST', x: 42, y: 50}], links: [['GK', 'LCB'], ['GK', 'RCB'], ['LB', 'LCB'], ['LCB', 'RCB'], ['RCB', 'RB'], ['LB', 'LCM'], ['LCB', 'CM'], ['RCB', 'CM'], ['RB', 'RCM'], ['LCM', 'CM'], ['CM', 'RCM'], ['LCM', 'ST'], ['CM', 'ST'], ['RCM', 'ST']] },
    { id: '3-4-1', name: 'Ofensiva (3-4-1)', pos: [{role: 'GK', x: 4, y: 50}, {role: 'LCB', x: 15, y: 25}, {role: 'CB', x: 12, y: 50}, {role: 'RCB', x: 15, y: 75}, {role: 'LM', x: 28, y: 15}, {role: 'LCM', x: 26, y: 35}, {role: 'RCM', x: 26, y: 65}, {role: 'RM', x: 28, y: 85}, {role: 'ST', x: 42, y: 50}], links: [['GK', 'LCB'], ['GK', 'CB'], ['GK', 'RCB'], ['LCB', 'CB'], ['CB', 'RCB'], ['LCB', 'LM'], ['LCB', 'LCM'], ['CB', 'LCM'], ['CB', 'RCM'], ['RCB', 'RCM'], ['RCB', 'RM'], ['LM', 'LCM'], ['LCM', 'RCM'], ['RCM', 'RM'], ['LM', 'ST'], ['LCM', 'ST'], ['RCM', 'ST'], ['RM', 'ST']] }
  ],
  10: [
    { id: '4-4-1', name: 'Equilibrada (4-4-1)', pos: [{role: 'GK', x: 4, y: 50}, {role: 'LB', x: 15, y: 15}, {role: 'LCB', x: 12, y: 35}, {role: 'RCB', x: 12, y: 65}, {role: 'RB', x: 15, y: 85}, {role: 'LM', x: 28, y: 15}, {role: 'LCM', x: 26, y: 35}, {role: 'RCM', x: 26, y: 65}, {role: 'RM', x: 28, y: 85}, {role: 'ST', x: 42, y: 50}], links: [['GK', 'LCB'], ['GK', 'RCB'], ['LB', 'LCB'], ['LCB', 'RCB'], ['RCB', 'RB'], ['LB', 'LM'], ['LCB', 'LCM'], ['RCB', 'RCM'], ['RB', 'RM'], ['LM', 'LCM'], ['LCM', 'RCM'], ['RCM', 'RM'], ['LM', 'ST'], ['LCM', 'ST'], ['RCM', 'ST'], ['RM', 'ST']] },
    { id: '3-4-2', name: 'Ofensiva (3-4-2)', pos: [{role: 'GK', x: 4, y: 50}, {role: 'LCB', x: 15, y: 25}, {role: 'CB', x: 12, y: 50}, {role: 'RCB', x: 15, y: 75}, {role: 'LM', x: 28, y: 15}, {role: 'LCM', x: 26, y: 35}, {role: 'RCM', x: 26, y: 65}, {role: 'RM', x: 28, y: 85}, {role: 'LST', x: 42, y: 35}, {role: 'RST', x: 42, y: 65}], links: [['GK', 'LCB'], ['GK', 'CB'], ['GK', 'RCB'], ['LCB', 'CB'], ['CB', 'RCB'], ['LCB', 'LM'], ['LCB', 'LCM'], ['CB', 'LCM'], ['CB', 'RCM'], ['RCB', 'RCM'], ['RCB', 'RM'], ['LM', 'LCM'], ['LCM', 'RCM'], ['RCM', 'RM'], ['LM', 'LST'], ['LCM', 'LST'], ['RCM', 'RST'], ['RM', 'RST'], ['LST', 'RST']] },
    { id: '4-3-2', name: 'Control (4-3-2)', pos: [{role: 'GK', x: 4, y: 50}, {role: 'LB', x: 15, y: 15}, {role: 'LCB', x: 12, y: 35}, {role: 'RCB', x: 12, y: 65}, {role: 'RB', x: 15, y: 85}, {role: 'LCM', x: 26, y: 25}, {role: 'CM', x: 24, y: 50}, {role: 'RCM', x: 26, y: 75}, {role: 'LST', x: 42, y: 35}, {role: 'RST', x: 42, y: 65}], links: [['GK', 'LCB'], ['GK', 'RCB'], ['LB', 'LCB'], ['LCB', 'RCB'], ['RCB', 'RB'], ['LB', 'LCM'], ['LCB', 'LCM'], ['LCB', 'CM'], ['RCB', 'CM'], ['RCB', 'RCM'], ['RB', 'RCM'], ['LCM', 'CM'], ['CM', 'RCM'], ['LCM', 'LST'], ['CM', 'LST'], ['CM', 'RST'], ['RCM', 'RST'], ['LST', 'RST']] }
  ],
  11: [
